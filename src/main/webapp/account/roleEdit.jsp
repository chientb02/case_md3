...
<body>
<a style="border-radius: 10px; color: #ff3f70; background-color: white; font-size: medium" class="btn btn-info" class="btn btn-info" href="/account?action=role">Quay lại</a>
<div class="form">
  <div class="form__box">
    ...
    <div class="form__right">
      <div class="form__padding-right">
        <form action="/account?action=roleUpdate&&id=${roles.getId()}" method="post">
          <h1 class="form__title">Sửa tài khoản</h1>
