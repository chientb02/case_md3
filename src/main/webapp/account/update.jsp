  ...
  <style id="INLINE_PEN_STYLESHEET_ID">
    ...
    * {
    ...
    .form {
      ...
      margin: 50px auto;
      padding: 45px 65px;
      background: linear-gradient(to right, #ef6085, #71df88);
      border-radius: 40px;
    }
    .form__box {
      width: 100%;
...
<body>
<a style="border-radius: 10px; color: #ff3f70; background-color: white; font-size: medium" class="btn btn-info" class="btn btn-info" href="/account">Quay lại</a>
<div class="form">
  <div class="form__box">
    ...
    <div class="form__right">
      <div class="form__padding-right">
        <form action="/account?action=update" method="post">
          ...
          <input name="oldPass" class="form__password" type="password" placeholder="Nhập mật khẩu hiện tại">
          <input name="newPass" class="form__password" type="password" placeholder="Nhập mật khẩu mới">
          <input name="confirmPass" class="form__password" type="password" placeholder="Nhập lại mật khẩu mới">
          <input class="form__submit-btn" type="submit" value="Cập nhật">
        </form>
