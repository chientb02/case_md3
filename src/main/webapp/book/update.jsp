...
<div class="container">
  ...
  <form style="width: 500px; margin: auto"
        action="/book?action=updatePost&&id=${id}" method="post">
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control"
             id="image" name="image" value="${image}" required>
    </div>
    <div class="mb-3">
      <label for="description" class="form-label">Miêu tả sách</label>
      <input type="text" class="form-control"
             id="description" name="description" value="${description}" required>
    </div>
    <div class="mb-3">
      <label for="status" class="form-label">Trạng thái sách</label>
      <input type="text" class="form-control"
             id="status" name="status" value="${status}" required>
    </div>
